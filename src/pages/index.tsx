  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience convenience at your fingertips with B2C Car Sharing. Book available cars near you, managed seamlessly by dedicated operations staff."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjByZW50YWx8ZW58MHx8fHwxNjkyMjY0ODMzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience convenience at your fingertips with B2C Car Sharing. Book available cars near you, managed seamlessly by dedicated operations staff.`}
            </Text>
            <Box
